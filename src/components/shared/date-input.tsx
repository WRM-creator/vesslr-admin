...
interface DateInputProps {
  ...
  className?: string; // Added className prop for better styling control
}
  ...
  return (
    ...
    >
      <input
        ...
        className="w-4 border-none bg-transparent p-0 text-center outline-none"
        placeholder="M"
      />
      ...
      <input
        ...
        className="w-5 border-none bg-transparent p-0 text-center outline-none"
        placeholder="D"
      />
      <span className="-mx-px opacity-20">/</span>
      <input
        ...
        className="w-9 border-none bg-transparent p-0 text-center outline-none"
        placeholder="YYYY"
      />
    </div>
  );
