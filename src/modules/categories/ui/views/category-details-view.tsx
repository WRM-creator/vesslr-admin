...
export default function CategoryDetailsView() {
  const { id } = useParams();
  const [accordionValue, setAccordionValue] = useState<string[]>(["identity", "eligibility"]);
  ...
  return (
    <div className="container mx-auto py-4 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_240px] gap-8 relative items-start">
        <div className="min-w-0">
          ...
          >
            ...
            <CategorySection
              ...
              className="opacity-90 border-blue-200 dark:border-blue-900"
